...
const ProductListing = () => {
  ...
  return (
    ...
    <div className="filter-container">
      ...
      <div className="filter-icon" onClick={() => setIsFilterVisible(!isFilterVisible)}>
        <span role="img" aria-label="filter"><i class="fa fa-solid fa-filter"></i></span> {/* You can replace this with an icon library like FontAwesome */}
      </div>
      ...
      <main className="products px-5">
        {filteredProducts.length > 0 ? (
          filteredProducts.map((product) => (
            <div key={product.id} className="product-card" onClick={(e) => detailsProd(e, product.id)}>
